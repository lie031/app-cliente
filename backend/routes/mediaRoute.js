...
router.post('/',                                                //Creamos el metodo post
    ...
    async (req, res) => {
        ...
        if (!errors.isEmpty()) {                                //Verificamos si hay algun error
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
router.put('/:id',                                               //Creamos el metodo put para actualizar, este metodo lleva un argumento id
    [
    ...
    async (req, res) => {
        try {
            ...
            if (!errors.isEmpty()) {                             //Verificamos si hay errores
                return res.status(400).json({errors: errors.array() });
            }
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
router.delete('/:id',                                            //Creamos un metodo delete con el argumento id pues necesitamos saber que elemento eliminar
    async (req, res) => {
        try {
