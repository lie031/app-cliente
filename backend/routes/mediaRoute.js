...
// ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// @route   GET /medias
// @desc    Obtener todas las medias (Accesible por 'administrador' y 'general')
// @access  Privado
router.get('/', auth, authorize(['administrador', 'general']), async (req, res) => {
...
// @route   GET /medias/:id
// @desc    Obtener una media por ID (Accesible por 'administrador' y 'general')
// @access  Privado
router.get('/:id', auth, authorize(['administrador', 'general']), async (req, res) => {
    try {
...
// ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// @route   POST /medias
// @desc    Crear una nueva media (Solo accesible por 'administrador')
// @access  Privado
router.post(
    '/', // Creamos el metodo post
    auth, // Autenticación primero
    authorize(['administrador']), // Luego autorización para el rol de 'administrador'
    [
...
// ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
// @route   PUT /medias/:id
// @desc    Actualizar una media existente (Solo accesible por 'administrador')
// @access  Privado
router.put(
...
// @desc    Eliminar una media (Solo accesible por 'administrador')
// @access  Privado
router.delete(
